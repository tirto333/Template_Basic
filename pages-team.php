        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Pages', 'title' => 'Team')); ?>
                            ...
                            <div>
                                ...
                                <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="member-overview">
                                    ...
                                    <div class="offcanvas-foorter border p-3 hstack gap-3 text-center position-relative">
                                        ...
                                        <a href="pages-profile.php" class="btn btn-primary w-100"><i class="ri-user-3-fill align-bottom ms-1"></i> View Profile</a>
                                    </div>
                                </div>
                                <!--end offcanvas-->
                            </div>
