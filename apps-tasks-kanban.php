...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Kanban Board')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Tasks', 'title' => 'Kanban Board')); ?>
                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
 												<h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Profile Page Structure</a></h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <li><a class="dropdown-item" href="apps-tasks-details.php"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                               <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Velzon - Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="todo-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Marketing & Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="inprogress-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="text-body d-block">Brand Logo Design</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Change Old App Icon</a></h6>
                                ...
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Create Product Animations</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Create a Graph of Sketch</a></h6>
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Create a Blog Template UI</a></h6>
                                                <div class="dropdown">
                                ...
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details.php" class="d-block">Banner Design for FB & Twitter</a></h6>
