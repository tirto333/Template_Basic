...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Marketplace')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'NFT Marketplace', 'title' => 'Marketplace')); ?>
                        ...
                        <div class="col-lg-12">
                            <div class="d-lg-flex align-items-center mb-4">
                                ...
                                <div class="flex-shrink-0 mt-4 mt-lg-0">
                                    <a href="apps-nft-explore.php" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details.php">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-lg-flex align-items-center mb-4">
                                ...
                                <div class="flex-shrink-0 mt-4 mt-lg-0">
                                    <a href="apps-nft-creators.php" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1"><a href="pages-profile.php">Tonya Noble</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1"><a href="pages-profile.php">Kevin Dawson</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1"><a href="pages-profile.php">Herbert Stokes</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1"><a href="pages-profile.php">Thomas Taylor</a></h5>
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mt-3 mb-1"><a href="pages-profile.php">James Price</a></h5>
