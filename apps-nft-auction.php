...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Live Auction')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'NFT Marketplace', 'title' => 'Live Auction')); ?>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Abstract Face Painting</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Patterns Arts & Culture</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Creative Filtered Portrait</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Smillevers Crypto</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Long-tailed Macaque</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">The Chirstoper</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Robotic Body Art</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.php">Evolved Reality</a></h6>
                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Creative filtered portrait</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Patterns arts & culture</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Evolved Reality</h6></a>
                                                                <p class="mb-0 text-muted">Sold at 34.81 ETH</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Smillevers Crypto</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Robotic Body Art</h6></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details.php"><h6 class="fs-15 mb-1">Trendy fashion portraits</h6></a>
