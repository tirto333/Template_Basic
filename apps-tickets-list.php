...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Tickets List')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Tickets', 'title' => 'Tickets List')); ?>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><button class="dropdown-item" onclick="location.href = 'apps-tickets-details.php';"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</button></li>
