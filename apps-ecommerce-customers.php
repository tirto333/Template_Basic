...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Customers')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Ecommerce', 'title' => 'Customers')); ?>
