...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Shopping Cart')); ?>
                        ...
                        <div class="col-xl-8">
                            <div class="row align-items-center gy-3 mb-3">
                                ...
                                <div class="col-sm-auto">
                                    <a href="apps-ecommerce-products.php" class="link-primary text-decoration-underline">Continue Shopping</a>
                                </div>
                            </div>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Sweatshirt for Men (Pink)</a></h5>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">Noise NoiseFit Endure Smart Watch</a></h5>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail.php" class="text-body">350 ml Glass Grocery Container</a></h5>
                            ...
                            <div class="text-end mb-4">
                                <a href="apps-ecommerce-checkout.php" class="btn btn-success btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout</a>
                            </div>
                        </div>
                        <!-- end col -->
