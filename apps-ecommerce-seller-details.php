...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Seller Details')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Ecommerce', 'title' => 'Seller Details')); ?>
                        ...
                        <div class="col-xxl-9">
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="apps-ecommerce-add-product.php" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                    </div>
                                </div>
                                <div class="col-sm">
