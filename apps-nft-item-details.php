...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Item Details')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Pages', 'title' => 'Item Details')); ?>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details.php" class="text-body"><span class="mb-0 ms-2">Brave Tigers NFT</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details.php" class="text-body"><span class="mb-0 ms-2">Creative filtered portrait</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details.php" class="text-body"><span class="mb-0 ms-2">Evolved Reality</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>130.39 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details.php" class="text-body"><span class="mb-0 ms-2">Robotic Body Art</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>
